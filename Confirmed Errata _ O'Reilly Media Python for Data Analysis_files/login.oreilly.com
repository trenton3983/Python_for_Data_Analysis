...
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["linkedin","facebook","googleplus","twitter"];
...
function getPackagePath(packages) {
    ...
    var path = rootPath + 'manifest/' + packages.join(':') + '?version=' + encodeURIComponent('1.110.0_widgets_497');
    return path;
}
